...
export default function FormCotizador() {
    ...
    return (
        <>
            ...
            <input type="number" name='metros2' placeholder='ej: 20' min={2} defaultValue={0} value={inputs.metros2} onChange={handleChanges}
            ...
            {co && <div className='flex flex-row pb-2 space-x-2 items-center align-middle'>
                ...
                <button className=' bg-white font-normal  h-9 px-1 py-2 rounded-md border-emerald-500 border text-emerald-600 text-sm hover:bg-emerald-500 hover:text-white transition-all duration-100'>Guardar Cotización</button>
            </div>
            }
        </>
    )
